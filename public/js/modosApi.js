...
(async function() {
	try {
		...
		const modoDescricao = [
			'É o modo Plant/Defuse padrão de VALORANT. As equipes jogam 12 rodadas em Ataque ou Defesa e depois trocam para o outro lado nas próximas 12 rodadas. A primeira a 13 rodadas vence, com uma rodada final de final de jogo disputada caso o jogo alcance um placar de 12-12. Tem um tempo de jogo estimado de 30 a 40 minutos.',
